        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg md:text-xl mb-8 text-gray-100">
              Connect with trusted chemical suppliers, storage providers, and transporters all in one platform.
            </p>
          ...
          <div className="hidden md:block">
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 transform hover:scale-105 transition">
                ...
                <p className="text-gray-100">Find chemicals with detailed specifications and safety data.</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 transform hover:scale-105 transition mt-8">
                ...
                <p className="text-gray-100">Access tanks and warehouses for your chemical storage needs.</p>
              </div>
              
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 transform hover:scale-105 transition">
                <Truck size={36} className="mb-4 text-chem-300" />
                <h3 className="text-xl font-semibold mb-2">Transportation</h3>
                <p className="text-gray-100">Connect with certified chemical transporters and freight forwarders.</p>
              </div>
